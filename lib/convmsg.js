...
module.exports = function(rule){
    ...
    return function(msg) {
        ...
        if (msg.type == 'start_game') {
            ...
            let title = (msg.names ? 'Mjaiサーバー' : 'RiichiLab')
            ...
            if (paipu.qijia == null) paipu.qijia = msg.oya;
                 ...
                 msg.type ==  'daiminkan')
        {
            ...
            let hule = {
                ...
                hupai:    msg.yakus.map(h =>({ name: YAKU[h[0]] ?? h[0],
                                               fanshu: h[1] })),
                fenpei:   fenpei
            };
            ...
            let pingju = {
                name:    RYUKYOKU[msg.reason] ?? msg.reason,
                shoupai: ['','','',''],
                fenpei:  fenpei
            };
            for (let id = 0; id < 4; id++) {
